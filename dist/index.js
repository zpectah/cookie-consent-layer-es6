...
class CookieConsentLayer {
     ...
     **/
    categoryDropdownToggleHandler(category, event) {
        const isCategoryCollapsed = event.target.classList.contains(this.selectors.stateClassName.isExpanded);
    ...
    initDropdownDomEvents() {
        this.nodes.dropdownButton().forEach((node) => {
            node.addEventListener('click', (e) => this.events.toggleDropdown(e, node.dataset.cclDropdownToggle));
        });
    }
    removeDropdownDomEvents() {
        this.nodes.dropdownButton().forEach((node) => {
            node.removeEventListener('click', (e) => this.events.toggleDropdown(e, node.dataset.cclDropdownToggle));
        });
    }
    /**
     * Renderers
    ...
    renderCategoryTable(showTable = true) {
        ...
        const getCategoryContent = (category) => {
            ...
            const expanded = this.options.consent.expandedCategory === 'all' || ((0, indexOf_1.default)(this.options.consent.expandedCategory, category) > -1);
